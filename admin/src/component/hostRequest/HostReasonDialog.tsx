...
import { acceptOrDeclineWithdrawRequestForAgency, acceptOrDeclineWithdrawRequestForHost } from "@/store/withdrawalSlice";
  ...
  const handleSubmit = (e: any) => {
    ...
    if (!reason) {
      ...
      if (dialogueType === "reasondialog") {
        const withdrawType = dialogueData?.withdrawType;
        if (withdrawType === "agency") {
          const payload = {
            reason,
